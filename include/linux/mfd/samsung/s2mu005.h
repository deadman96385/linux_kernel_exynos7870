...
#define S2MU005_CHGR_STAT_OFF		0
#define S2MU005_CHGR_STAT_INPUT_INVALID	0xf
...
/* S2MU005_REG_CHGR_CTRL12 */
#define S2MU005_CHGR_WDT		GENMASK(1, 0)

#define S2MU005_CHGR_WDT_ON		0x2
#define S2MU005_CHGR_WDT_OFF		0x1

/* S2MU005_REG_CHGR_CTRL13 */
#define S2MU005_CHGR_WDT_CLEAR		BIT(0)

/* S2MU005_REG_CHGR_CTRL18 */
#define S2MU005_CHGR_TIMER_CONFIG	GENMASK(5, 0)
#define S2MU005_CHGR_TIMER_90M_WDT_80S	0x35
...
/* S2MU005_REG_MUIC_ADC */
#define S2MU005_MUIC_ADC_CONVERSION	BIT(7)
#define S2MU005_MUIC_ADC_VALUE		GENMASK(4, 0)

#define S2MU005_MUIC_ADC_LANHUB		0x13
#define S2MU005_MUIC_ADC_TYPE1_CHG	0x17
#define S2MU005_MUIC_ADC_JIG_USB_OFF	0x18
#define S2MU005_MUIC_ADC_JIG_USB_ON	0x19
#define S2MU005_MUIC_ADC_DESKDOCK	0x1a
#define S2MU005_MUIC_ADC_TYPE2_CHG	0x1b
#define S2MU005_MUIC_ADC_JIG_UART_OFF	0x1c
#define S2MU005_MUIC_ADC_JIG_UART_ON	0x1d
#define S2MU005_MUIC_ADC_OPEN		0x1f
...
/* S2MU005_REG_MUIC_CHGTYPE */
#define S2MU005_MUIC_CHGTYPE_VBUS_R255	BIT(7)
#define S2MU005_MUIC_CHGTYPE_U200	BIT(4)
#define S2MU005_MUIC_CHGTYPE_SDP_1P8S	BIT(3)
#define S2MU005_MUIC_CHGTYPE_USB		BIT(2)
#define S2MU005_MUIC_CHGTYPE_CDP		BIT(1)
#define S2MU005_MUIC_CHGTYPE_DCP		BIT(0)
#define S2MU005_MUIC_CHGTYPE_FALLBACK	(S2MU005_MUIC_CHGTYPE_VBUS_R255 | \
					 S2MU005_MUIC_CHGTYPE_U200 | \
					 S2MU005_MUIC_CHGTYPE_SDP_1P8S)
